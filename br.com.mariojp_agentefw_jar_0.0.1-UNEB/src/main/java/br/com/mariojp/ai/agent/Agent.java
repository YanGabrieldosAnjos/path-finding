...
public abstract class Agent implements IAgent {
	...
	public String toString() {
		...
		sb.append("Time elapsed: " + (this.end.getTime() - this.start.getTime()) + " milisecs \n");
		sb.append("Total Nodes Expanded : "+ this.border.getNodes() +"\n");
		sb.append("Total Nodes Visited : "+ this.border.getVisits() +"\n");

		String name = "";
		switch (this.type) {
			case 0: name += "DEPTH_FIRST_SEARCH"; break;
			case 1: name += "BREADTH_FIRST_SEARCH"; break;
			case 2: name += "GREEDY_SEARCH"; break;
			case 3: name += "START_SEARCH"; break;
			case 4: name += "UNIFORM_COST_SEARCH"; break;
		}
		
		content += name + ";" + (this.end.getTime() - this.start.getTime()) + ";" + this.border.getNodes() + ";" + this.border.getVisits() + ";" + "\n";
		fw.fileWriter("br.com.mariojp_agentefw_jar_0.0.1-UNEB/src/test/resources/reports", "report", content);
		return sb.toString();
	}
